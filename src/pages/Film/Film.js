...
const Film = () => {
              ...
              <a className="navbar-brand" href="/" title="Home">
                <div className="hidden">
                  <img
                    ...
                    src="/Film/images/PM-2023logo-tr.svg"
            ...
            <div className="col-lg-4 col-md-5 d-none d-md-block align-self-center">
              <div className="float-right ">
                ...
                <div className="searchbar float-left">
                  ...
                  >
                    <img
                      src="/Film/images/iconSearch.png"
                      style={{ width: "25px" }}
                    />
                  </a>
                </div>
            ...
            >
              ...
              >
                <a
                  ...
                  href="https://www.peramuseum.org/"
                >
                  <img src="/Film/images/en_img.svg" alt className="imgnew" />
                </a>
                <a className="linkSearch btnSrch" id="btnSrchMobile" href="#">
                  <img src="/Film/images/search.svg" alt className="imgnew" />
                </a>
              </div>
            </div>
            <div
  ...
  */}
                  ...
                  <div className="card mb-1 border-0">
                    ...
                    <a href="/film-program/korkunun-yuzleri/3533">
                      <img
                        ...
                        width="100%"
                        height="100%"
                        src="/Film/images/korkunun-yuzleri-program.jpg"
                        alt="Korkunun Yüzleri"
                      />
                    </a>
                    <div className="card-body">
                      <h3 className="card-title listtitle">Korkunun Yüzleri</h3>
                      ...
                      />
                      <p>
                        Korku, sadece bir dehşet kaynağı değil, aynı zamanda
                        insan doğasının derinlerine ve karanlık köşelerine
                        açılan bir pencere. Program, sıradan hayatların kâbusa
                        dönüştüğü, bastırılmış duyguların en korkunç şekillerde
                        açığa çıktığı iki karanlık büyüme hikâyesini bir araya
                        getiriyor.
                      </p>
                      <p />
                    </div>
                ...
                <div className="col-lg-6 col-md-6 mb-4">
                  <div className="card mb-0 border-0">
                    ...
                    <a href="/pera-film-hakkinda">
                      <img
                        className="bd-placeholder-img card-img-top"
                        src="/Film/images/pera-film-hakkinda.jpg"
                ...
                <div className="col-lg-6 col-md-6 mb-4">
                  <div className="card mb-0 border-0">
                    ...
                    <a href="/film/gecmis-programlar">
                      <img
                        className="bd-placeholder-img card-img-top"
                        src="/Film/images/perafilm-gecmisprogramlar.jpg"
        ...
        <div className="cookie-bar">
          <img src="/Film/images/close2.png" className="cookie-close" />
                  ...
                  <div className="col-md-5 col-sm-4 col-xs-12 col-lg-5 float-left order-1 plnew2">
                    <form action="/e-bulten-kayit" method="post">
                      <input
                        ...
                        type="hidden"
                        defaultValue="h3Q7wLoeEJWAdAWwKTYTNXSxWVZi7ihQUGf7odE1qt9o_HZi-8Bd9lOf2gE2luUfyE68YlGBJxBCvCGeh2Us_NkQYtJcbL6oWnlmR1RcDJc1"
                      />{" "}
                      <h2
            ...
            <div className="row pt-lg-2">
              ...
              >
                ...
                >
                  <img
                    ...
                    src="/Film/images/svikv-tr-logo.svg"
                    height={40}
              ...
              >
                ...
                >
                  <img
                    className="float-left pr-2"
                    src="/Film/images/iae-tr-logo.svg"
                    height={40}

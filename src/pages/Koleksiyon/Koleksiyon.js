...
const Koleksiyon = () => {
          ...
          <div className="row ptnew">
            ...
            <div className="col-lg-4 col-md-5 d-none d-md-block align-self-center">
              <div className="float-right ">
                ...
                >
                  <img
                    src="/Koleksiyon/images/iconLang.png"
                ...
                <div className="searchbar float-left">
                  ...
                  >
                    <img
                      src="/Koleksiyon/images/iconSearch.png"
                      style={{ width: "25px" }}
                    />
                  </a>
                </div>
  ...
  */}
                  ...
                  <div className="card mb-0 border-0">
                    ...
                    <a href="/koleksiyon/oryantalist-resim-koleksiyonu/1">
                      <img
                        ...
                        width="100%"
                        height="100%"
                        src="/Koleksiyon/images/cover-oryantalist.jpg"
                  ...
                  <div className="card mb-0 border-0">
                    ...
                    <a href="/koleksiyon/anadolu-agirlik-ve-olculeri-koleksiyonu/2">
                      <img
                        ...
                        width="100%"
                        height="100%"
                        src="/Koleksiyon/images/cover-anadoluagirlik.jpg"
                  ...
                  <div className="card mb-0 border-0">
                    ...
                    <a href="/koleksiyon/kutahya-cini-ve-seramikleri-koleksiyonu/3">
                      <img
                        ...
                        width="100%"
                        height="100%"
                        src="/Koleksiyon/images/cover-kutahya.jpg"
                  ...
                  <div className="card mb-0 border-0">
                    ...
                    <a href="/koleksiyon/koleksiyonlarimizi-3-boyutlu-kesfedin/25">
                      <img
                        ...
                        width="100%"
                        height="100%"
                        src="/Koleksiyon/images/cover-3d.jpg"
              ...
              <div className="row">
                <div className="col-md-6 mb-4" style={{}}>
                  ...
                  <img
                    className="bd-placeholder-img card-img-top"
                    width="100%"
                    src="/Koleksiyon/images/kapak-KoleksiyonSergileri.jpg"
                ...
                <div className="col-md-6 mb-4" style={{}}>
                  ...
                  <a href="/sergi/gecmis-koleksiyon-sergileri/1">
                    <img
                      className="bd-placeholder-img card-img-top"
                      width="100%"
                      src="/Koleksiyon/images/gecmis_koleksiyon_sergileri.jpg"
        ...
        <div className="cookie-bar">
          <img src="/Koleksiyon/images/close2.png" className="cookie-close" />
                  ...
                  <div className="col-md-5 col-sm-4 col-xs-12 col-lg-5 float-left order-1 plnew2">
                    <form action="/e-bulten-kayit" method="post">
                      <input
                        ...
                        type="hidden"
                        defaultValue="4rEAXNJooGpC9NogqcdMKWnsbbwjLbPaYbQdv8TCwvy758-ttDAu5mc2o-XudsOsrlMvGl6Ab-eeH0nWrbjpHm2D9TFhZ_0OzDHQqzncRlA1"
                      />{" "}
                      <h2
            ...
            <div className="row pt-lg-2">
              ...
              >
                ...
                >
                  <img
                    ...
                    src="/Koleksiyon/images/svikv-tr-logo.svg"
                    height={40}
              ...
              >
                ...
                >
                  <img
                    className="float-left pr-2"
                    src="/Koleksiyon/images/iae-tr-logo.svg"
                    height={40}
